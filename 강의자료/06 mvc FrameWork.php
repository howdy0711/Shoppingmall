06-1. Request클래스 : Request URL을 분석하여 처리 분배를 위한 데이터를 획득

Client로 부터 입력값 : Get방식, Post방식( $_GET, $_POST 슈퍼글로벌 변수)
URL처리를 통해 Controller와 Action명을 획득
...
- Base가 되는 URL: Host부분을 뺀 부분의 경로, /foo/bar/
...
e3) http://example.com/foo/bar/user (/foo/bar 폴더에 index.php 저장)
